...
type instance_object_state_v4 = {
  index_key: [ `Int of int | `String of string ] option [@key "index_key"] [@default None];
  ...
  attributes_flat: (string * string) list option [@key "attributes_flat"] [@default None];
  ...
  create_before_destroy: bool option [@key "create_before_destroy"] [@default None];
} [@@deriving yojson]
...
type state_v4 = {
  ...
  check_results: check_results_v4 list option [@key "check_results"] [@default None];
} [@@deriving yojson]
